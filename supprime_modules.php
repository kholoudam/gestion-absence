   ...
   <?php
        ...
        else
        {
            ...
            if($request_method=='POST'){
                ...
                $query = 'SELECT nom_module FROM modules WHERE nom_module = "'.$_REQUEST['nom_module'].'"';
                $query='DELETE FROM modules WHERE nom_module = "'.$_REQUEST['nom_module'].'"';
                //echo $query;
                if(mysqli_query($conn, $query))
                {
                    $message ='<BR>Module supprimé avec succés.<BR>';
                }
                else
                {
                    $message ='<BR>Echec de supression du module .<BR>';
                }
                //echo $message;
                    ...
                    <div class="col-lg-7 col-xxl-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="text-dark mb-4" style="font-family: Bitter, serif;font-weight: bold;">Supprimer un module</h1>
                            </div>
